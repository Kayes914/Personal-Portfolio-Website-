      ...
      <div className="bg-slate-900 rounded-lg border border-slate-800 p-6 mb-6">
        ...
        <div className="flex items-center">
          ...
          <Link 
            ...
            className="ml-4 text-slate-300 hover:text-white text-sm underline"
          >
...
{`CREATE TABLE IF NOT EXISTS projects (
  ...
  updated_at TIMESTAMPTZ
            ...
            <p className="mt-4">Then, navigate to <a href="/dashboard/projects/manage" className="text-blue-400 hover:text-blue-300">Projects Management</a> to manage your portfolio.</p>
          </div>
        </div>
      </div>
    </DashboardLayout>
