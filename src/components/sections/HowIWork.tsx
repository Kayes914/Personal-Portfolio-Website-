  ...
  return (
    <section id="how-i-work" className="relative py-24 overflow-hidden bg-[#0B0D17]">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 -left-32 w-64 h-64 bg-blue-600/5 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="inline-flex items-center px-4 py-1 mb-6 rounded-full bg-gradient-to-r from-purple-900/30 to-blue-900/30 border border-purple-700/30">
            <span className="text-sm font-medium text-purple-400">My Process</span>
          </div>
          ...
          <div className="w-20 h-0.5 bg-gradient-to-r from-purple-500 to-blue-500 mx-auto mb-6"></div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <div className="absolute top-1/2 left-1/4 w-96 h-96 bg-blue-500/10 rounded-full blur-3xl transform -translate-y-1/2"></div>
            ...
            <div className="relative max-w-7xl mx-auto">
              {/* Enhanced Circular Steps */}
               <div className="relative">
                 ...
                 <div className="absolute top-7 left-1/2 transform -translate-x-1/2 w-full h-0.5 hidden lg:block" style={{ maxWidth: 'calc(80rem - 320px)' }}>
                   <div className="relative w-full h-full bg-slate-700/30">
                     ...
                     {isPlaying && (
                       <motion.div
                         className="absolute top-1/2 w-2 h-2 bg-white rounded-full shadow-lg transform -translate-y-1/2 border border-blue-400"
                         animate={{
                     ...
                     >
                       ...
                       >
                         ...
                         <div className={`absolute -top-0.5 -right-0.5 w-3 sm:w-4 lg:w-5 h-3 sm:h-4 lg:h-5 rounded-full flex items-center justify-center text-xs font-semibold transition-all duration-300 ${
                           ...
                           <span className="text-xs sm:text-xs lg:text-xs" style={{ fontSize: '10px' }}>{step.id}</span>
                         </div>
                       </motion.button>
           ...
           <AnimatePresence mode="wait">
             ...
             >
               ...
               <div className={`relative p-6 md:p-8 rounded-2xl transition-all duration-700 ${
                 'bg-gradient-to-br from-white/5 via-white/2 to-transparent border border-white/10 shadow-2xl backdrop-blur-sm'
               }`}>
                       ...
                       {/* Step Header */}
                           ...
                           <div className="flex items-center gap-3">
                             <div className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                               'bg-gradient-to-br from-blue-500 to-purple-600 text-white shadow-xl shadow-blue-500/30'
                             }`}>
